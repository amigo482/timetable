...
class Modal extends Component {
  render() {
    const {modal, setCurrentModal, updateLibraryRequest, addLibraryRequest, current, libraries, faculty, addTimetable,  currentTimetable, updateTimetable, getTimes, times} = this.props;
    switch(modal) {
      case 'edit':
